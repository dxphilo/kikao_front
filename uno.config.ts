...
export default defineConfig({
  shortcuts: [
    ...
    ['avatar_icon', 'h-9 w-9 cursor-pointer rounded-full bg-cover object-cover'],
    ...
    ['share_button', 'h-14 w-14 flex items-center justify-center border border-gray-300 rounded-full hover:bg-gray-100'],
    ['header_text', 'text-3xl font-sans text-center font-semibold leading-9  tracking-wide text-[#222222] md:text-4xl '],
    ['b_header', 'text-xl font-sans font-medium leading-9  tracking-wide text-[#222222] md:text-2xl'],
    ...
    ['btn_signup', 'px-12 py-3 rounded-lg inline-block border border-gray-300 text-base font-normal text-gray-900 cursor-pointer hover:bg-gray-300 disabled:cursor-default disabled:bg-gray-600 disabled:opacity-50 focus:outline-none focus:z-10 focus:ring-4 focus:ring-gray-200'],
    ['terms', 'text-black underline-offset-8 hover:underline'],
  ],
  presets: [
    presetUno(),
    presetAttributify(),
