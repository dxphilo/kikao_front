      ...
      <div class="w-full flex items-center justify-center pt-20">
        <div class="md:text-justified items-center text-center">
          ...
          <span class="inline-block py-10 text-base font-light text-gray-500">
            Please note that phone verification is required for signup. Your phone number will be solely used for identity verification to ensure security.
          </span>
          <div class="w-full flex flex-col gap-y-5 py-8">
            <div class="w-full flex">
              <span class="flex flex-col gap-y-1 overflow-hidden border border-r-0 border-gray-300 rounded-l-md p-2 text-gray-900">
              ...
              <input v-model="telNumber" min="10" max="10" type="text" class="w-full flex-1 border border-gray-300 rounded-none rounded-r-lg bg-gray-50 py-1.5 pl-10 text-base text-gray-900 focus:border-gray-500 focus:ring-gray-500" placeholder="Enter telephone number">
            </div>
          </div>
        </div>
      </div>
      <button
        type="submit" class="mt-10 block w-full flex cursor-pointer items-center justify-center gap-x-4 rounded-full bg-gray-200 px-18 py-4 text-center text-lg hover:bg-gray-300"
